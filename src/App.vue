<template>
  <div id="app">
    <div id="nav">
      ...
      <router-link to="/slice">Slice</router-link> |
...
@font-face {
  ...
  src: url("VisbyCF-ThinOblique.otf");
  font-weight: 100;
  font-style: normal;
}
...
@font-face {
  ...
  src: url("VisbyCF-RegularOblique.otf");
  font-weight: 400;
  font-style: normal;
}
